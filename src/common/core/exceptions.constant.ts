export type ExceptionStructure = { code: string; message: string };
export type ExceptionConstant = Record<string, ExceptionStructure>;

export const EXCEPTION_CONSTANT: ExceptionConstant = {
